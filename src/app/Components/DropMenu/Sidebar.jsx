...
const Sidebar = () => {
    ...
    return (
        <div id="drawer-right" className="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full w-60 bg-gray-800" aria-labelledby="drawer-right-label">
