...
<div className="mt-auto w-full container py-10 mx-auto md:px-0 px-5">
...
<div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
  ...
  <div>
    <h4 className="text-xs font-semibold text-gray-300 uppercase">Product</h4>

    <div className="mt-3 grid space-y-3 text-sm">
      <p><a className="inline-flex gap-x-2 text-gray-300 hover:text-gray-500 focus:outline-none focus:text-gray-500" href="#">Pricing</a></p>
      <p><a className="inline-flex gap-x-2 text-gray-300 hover:text-gray-500 focus:outline-none focus:text-gray-500" href="#">Changelog</a></p>
      <p><a className="inline-flex gap-x-2 text-gray-300 hover:text-gray-500 focus:outline-none focus:text-gray-500" href="#">Docs</a></p>
      <p><a className="inline-flex gap-x-2 text-gray-300 hover:text-gray-500 focus:outline-none focus:text-gray-500" href="#">Download</a></p>
    </div>
  </div>
